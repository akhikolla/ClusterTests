...
TEST(BAMBI_deepstate_test,log_const_univm_all_test){
  std::ofstream par_mat_stream;
  RInside();
  std::cout << "input starts" << std::endl;
  arma::mat par_mat  = RcppDeepState_mat();
  par_mat_stream.open("/home/akolla/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/compileAttributes/BAMBI/inst/testfiles/log_const_univm_all/inputs/par_mat");
