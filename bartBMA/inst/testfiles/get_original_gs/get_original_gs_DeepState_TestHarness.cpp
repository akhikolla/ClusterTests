...
TEST(bartBMA_deepstate_test,get_original_gs_test){
  ...
  low_stream.open("/home/akolla/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/compileAttributes/bartBMA/inst/testfiles/get_original_gs/inputs/low");
  low_stream << low;
  std::cout << "low values: "<< low << std::endl;
  low_stream.close();
  double high  = RcppDeepState_double();
  high_stream.open("/home/akolla/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/compileAttributes/bartBMA/inst/testfiles/get_original_gs/inputs/high");
  high_stream << high;
  std::cout << "high values: "<< high << std::endl;
  high_stream.close();
  double sp_low  = RcppDeepState_double();
  sp_low_stream.open("/home/akolla/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/compileAttributes/bartBMA/inst/testfiles/get_original_gs/inputs/sp_low");
  sp_low_stream << sp_low;
  std::cout << "sp_low values: "<< sp_low << std::endl;
  sp_low_stream.close();
  double sp_high  = RcppDeepState_double();
  sp_high_stream.open("/home/akolla/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/compileAttributes/bartBMA/inst/testfiles/get_original_gs/inputs/sp_high");
  ...
  sum_preds_stream.open("/home/akolla/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/compileAttributes/bartBMA/inst/testfiles/get_original_gs/inputs/sum_preds");
