...
TEST(bartBMA_deepstate_test,find_internal_nodes_pred_test){
  ...
  treetable_stream.open("/home/akolla/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/compileAttributes/bartBMA/inst/testfiles/find_internal_nodes_pred/inputs/treetable");
